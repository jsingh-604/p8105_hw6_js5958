...
Model Comparison:
```{r}
model_1 <- lm(data = df_weight, bwt ~ blength + gaweeks)

model_2 <- lm(data = df_weight, bwt ~ bhead + blength + babysex + bhead*blength + bhead*babysex + blength*babysex + bhead*blength*babysex)
```
